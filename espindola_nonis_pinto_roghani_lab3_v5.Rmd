...
This model attempts to directly address the research question.
...
This model attempts to improve upon the base model by incorporating additional explanatory variables.
...
```{r m3_correlation}
pScatterMatrix(crime, columns = c(26,4,5,6,27)) # TODO - PUT REAL REGRESSORS
```
...
- $\beta_1$ : `prbarr`        is `r coef(m3)[2]`, every 1% increase in probability of arrest     is associated with a `r coef(m3)[1]`% decrease in crime rate
- $\beta_2$ : `prbconv`       is `r coef(m3)[3]`, every 1% increase in probability of conviction is associated with a `r coef(m3)[2]`% decrease in crime rate
- $\beta_3$ : `avgsen.log`    is `r coef(m3)[4]`, every 1% increase in average prison sentence   is associated with a `r coef(m3)[3]`% increase in crime rate
- $\beta_4$ : `polpc.log`     is `r coef(m3)[5]`, every 1% increase in police per capita         is associated with a `r coef(m3)[4]`% increase in crime rate
- $\beta_5$ : `mix.log`       is `r coef(m3)[6]`, every 1% increase in offense mix               is associated with a `r coef(m3)[5]`% increase in crime rate
- $\beta_7$ : `density.log`   is `r coef(m3)[7]`, every 1% increase in density                   is associated with a `r coef(m3)[6]`% increase in crime rate
- $\beta_8$ : `pctmin80`      is `r coef(m3)[8]`, every 1% increase in percent minority          is associated with a `r coef(m3)[7]`% increase in crime rate
