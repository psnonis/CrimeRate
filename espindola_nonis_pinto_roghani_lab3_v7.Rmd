...
There is an extreme outlier on the left tail of the data. Upon further investigation, we realize this is county 115 (observation 51), and this very low crime rate might be due to the very low density of the county (below the 1st quartile). For that, we don’t have a strong reason to believe it is an error or irrelevant to our model, and leave it as is.
...
We started this study with the following research question: Could increasing certainty and severity of punishment associated with reducing crime rate?
